...
TEST_CASE( "ángulos internos de triángulos" ) {
   ...
   SUBCASE( "triángulo con área cero" ) {
      Vertex a(1,2);
      Vertex b(5,4);
      Vertex c(3,3);
...
TEST_CASE( "is convex" ) {
   ...
   SUBCASE ( "convexo" ) {
      poly.push(Vertex(1,1));
      poly.push(Vertex(4,0));
      poly.push(Vertex(7,2));
      poly.push(Vertex(6,5));
      poly.push(Vertex(3,6));
      poly.push(Vertex(1,4));

      CHECK( is_convex(poly) );
   }
   ...
   SUBCASE( "no convexo" ) {
      ...
      CHECK_FALSE( is_convex(poly) );
   }
}

TEST_CASE( "área del polígono" ) {
   Poly poly;
   poly.push(Vertex(1,1));
   poly.push(Vertex(4,0));
   poly.push(Vertex(7,2));
   ...
   CHECK( area(poly) == doctest::Approx(25.5) );
}
...
TEST_CASE( "tangent vertices" ) {
   Poly poly;
   poly.push(Vertex(1,2));
   poly.push(Vertex(2,1));
   poly.push(Vertex(3,1));
   poly.push(Vertex(4,2));
